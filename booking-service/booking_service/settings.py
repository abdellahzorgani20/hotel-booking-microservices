...
SECRET_KEY = config('SECRET_KEY', default='super-secret-jwt-key-change-in-production-min-50-chars')
DEBUG = config('DEBUG', default=True, cast=bool)
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='*').split(',')

AUTH_SERVICE_URL = config('AUTH_SERVICE_URL', default='http://localhost:8001')
HOTEL_SERVICE_URL = config('HOTEL_SERVICE_URL', default='http://localhost:8002')
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'bookings.authentication.MicroserviceJWTAuthentication',
    ],
